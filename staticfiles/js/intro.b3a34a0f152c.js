...
(function () {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function position() {
            ...
            // Offsets calibrated against the rendered glyph: the inline box
            // sits up and to the left of the actual "o" ink.
            const cx = r.left + r.width / 2 + size * 0.30;
            const cy = r.top + r.height * 0.57 + size * 0.42;

            intro.style.setProperty("--ox", cx.toFixed(2) + "px");
            intro.style.setProperty("--oy", cy.toFixed(2) + "px");
            intro.style.setProperty("--hole", (size * 0.155).toFixed(2) + "px");
